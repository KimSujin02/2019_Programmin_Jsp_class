...
<body bgcolor = "#fffcc">
	...
	String num1 = null; String num2 = null; String zipcode = null;
	String address = null; String jobs = null;
	...
	<div align="center">
		<br /><br />
		<form method="post" action = "updatePro_2306.jsp">
			<table border="1" width="600">
			<tr>
				<td colspan="3"><b>회원 정보 수정</b></td>
			</tr>
			<tr>
				<td width="20%">아이디</td><td width="50%"><%=id %></td>
			</tr>
			<tr>
				<td>이름</td><td><%=name %></td>
			</tr>
			<tr><td>주민등록번호</td><td><%=num1 %> - <%=num2 %></td></tr>
			<tr><td>Email</td><td><input name="email" value="<%=email %>" size="30"></td></tr>
			<tr><td>전화번호</td><td><input name="phone" value="<%=phone %>" size="12"></td></tr>
			<tr><td>우편번호</td><td><input name="zipcode" value="<%=zipcode %>" size="5"></td></tr>
			<tr><td>주소</td><td><input name="address" value="<%=address %>" size="45"></td></tr>
			<tr><td>직업</td><td><input type="text" name="jobs" value="<%=jobs %>"></td></tr>
