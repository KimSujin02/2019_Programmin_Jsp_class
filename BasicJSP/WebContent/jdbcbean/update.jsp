	...
	<div align = "center">
		...
		<form method = "post" action = "updatePro.jsp">
			<table border = "1" width = "600">
				...
				<tr>
					<td width = "20%">아이디</td>
					<td width = "50%"><input type=text name=id value="<%=regBean.getId()%>" style = "background-color:lightgray" readonly></td>
				</tr>
				<tr>
					<td>이름</td>
					<td><input type=text name=name value="<%=regBean.getName()%>" style = "background-color:lightgray" readonly></td>
				</tr>
				<tr>
					<td>주민등록번호</td>
					<td><input type=text name=num1 value="<%=regBean.getNum1()%>" style = "background-color:lightgray" readonly>
					 - <input type=text name=num2 value="<%=regBean.getNum2()%>" style = "background-color:lightgray" readonly> </td>
				</tr>
				<tr>
					<td>Email</td>
